#if !defined(ROCKET_NET_RPC_RPC_CHANNEL_H)
...
public:
    ...
    void Init(controller_s_ptr controller, message_s_ptr request, message_s_ptr reponse, closure_s_ptr closure);
...
private:
    ...
    TcpClient::s_ptr m_tcpclient {nullptr};
